...
export const Form = () => { 
  ...
  return (
    <div className='containerForm' id='formulario'>
      ...
      <div className='containerFormForm'>
        ...
        <h1 className='titleForm'>Formulario de Contacto</h1> 
          <form onSubmit={sendEmail} ref={form} > 
            ...
            <textarea className='inputFormConsulta' name="consultas" rows={5} cols={64} placeholder='Ingrese sus dudas o consultas'></textarea>
