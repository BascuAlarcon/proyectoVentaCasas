...
export const Ubicacion = () => {
  return (
    <>
      <div className='containerUbicacionId' id='ubicacion'>Elemento oculto</div>
      <div className='containerUbicacion'>
        <div className='containerTitleUbicacion'>Ubicación</div>
        <div className='containerContenidoUbicacion'>
          <div className="containerUbicacionTexto"> 
