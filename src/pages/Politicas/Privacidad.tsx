...
export const Privacidad = () => {
  return (
    <div className='privacidadContainer'>
        <div className='containerPrivacidadId' id='privacidad'>Elemento oculto</div>
        <p className='text-dark titlePrivacidad  '>
            <strong>POLÍTICA DE PRIVACIDAD</strong>
        </p>
        <p className='text-dark p-2'>El presente Política de Privacidad establece los términos en que InmobiliariaCV usa y 
        ...
        <p className='text-dark p-2'>InmobiliariaCV está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para 
        ...
        <p className='text-dark p-2'>InmobiliariaCV Se reserva el derecho de cambiar los términos de la presente Política de Privacidad 
